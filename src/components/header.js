...
import headerStyle from './header.module.scss' // headerStyle could be any name
//import './header.scss'  this style will be accessable globaly even though not imported to other components. to prevent this we need to use css module
const Header = () => {
